...
export HIVESEC_TELEGRAM_BOT_TOKEN="$(security find-generic-password -s HIVESEC_TELEGRAM_BOT_TOKEN -w)"
export HIVESEC_TELEGRAM_CHAT_ID="$(security find-generic-password -s HIVESEC_TELEGRAM_CHAT_ID -w)"
export HIVESEC_GITHUB_TOKEN="$(security find-generic-password -s HIVESEC_GITHUB_TOKEN -w)"
